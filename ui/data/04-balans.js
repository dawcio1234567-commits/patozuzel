...
const ECON={
 ...
 mechBuyout : 0.35,
 /* SPRINT 5b: MECHANIK JEST NA ETACIE, NIE NA ZAWSZE. Tyle procent jego ceny
    schodzi z budżetu PRZY STARCIE KAŻDEGO SEZONU. Nie stać cię — zwija skrzynkę
    i wracasz do klubowego z łapanki. Płaci to mechPaySeason() w engine/13. */
 mechSeason : 0.55,
 mechSeasonMin : 6000,      // podłoga, żeby tani fachowiec też coś kosztował
