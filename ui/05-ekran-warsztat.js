...
function workshop(){
 ...
 <div class="p-2 text-[11px] text-zinc-400 border-b border-zinc-700">
   Zatrudniasz JEDNEGO mechanika na sezon. Gorszego od obecnego (${p.mech}) nie da się kliknąć — kasa nie znika
